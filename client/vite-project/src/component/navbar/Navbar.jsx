          ...
          <div className="ml-auto flex items-center">
            ...
            {auth?.user?.role==1?(<>  <Link to={'/dashboard'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
             ...
             {!auth.user?(<> <Link to={'/logIn'} className="text-sm font-medium text-gray-700 cursor-pointer  " style={{ color: mode === 'dark' ? 'white' : '', }}>
                Login/Register
              </Link></>):(<> <div onClick={HandleLogOut} className="text-sm font-medium text-gray-700 cursor-pointer  " style={{ color: mode === 'dark' ? 'white' : '', }}>
                Logout
              </div></>)}
            </div>
{/* 
           ...
           {!auth.user?(<></>):(<> <div className="hidden lg:ml-8 lg:flex">
            ...
            <div className="ml-4 flow-root lg:ml-6">
              <Link to={'/cart'} className="group -m-2 flex items-center p-2" style={{ color: mode === 'dark' ? 'white' : '', }}>
                ...
                <span className="ml-2 text-sm font-medium text-gray-700 group-" style={{ color: mode === 'dark' ? 'white' : '', }}>{cart?.length}</span>
