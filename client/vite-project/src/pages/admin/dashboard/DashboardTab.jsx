...
const DashboardTab = () => {
  ...
  const GetProduct = async () => {
    try {
      const { data } = await axios.get(
        `${import.meta.env.VITE_APP_API}/api/product/getProducts`
      );
  ...
  const GetUser = async () => {
    try {
      const { data } = await axios.get(
        `${import.meta.env.VITE_APP_API}/api/auth/getUser`
      );
      const { users } = data;
      setUser(users);
    } catch (error) {
  ...
  const handleDelete = async (id) => {
    try {
      const { data } = await axios.delete(
        `${import.meta.env.VITE_APP_API}/api/product/deleteProduct/${id}`
      );
