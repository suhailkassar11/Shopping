...
function Cart() {
  ...
  const [instanse,setInstanse]=useState(true)
  const [clientToken,setClientToken]=useState("")
  const getToken=async()=>{
      try {
        const {data}=await axios.get(`${import.meta.env.VITE_APP_API}/api/product/braintree/token`)
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
          ...
          >
            ...
            <div className="flex justify-between mb-3">
              ...
              />
              <button className="bg-blue-500 text-black rounded-md p-2 font-medium hover:scale-105 font-serif" >make payment</button>
            {/* <Modal
            name={name}
            address={address}
            pincode={pincode}
